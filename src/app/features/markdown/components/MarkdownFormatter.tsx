...
const defaultReadmeContent = `# AI 编辑工作室
一个基于 Next.js 构建的 AI 编辑工作室，帮助用户组织写作风格提示词，并通过大型语言模型（LLM）生成高质量内容。适用于作家、内容创作者、学生和需要创作文案的专业人员。
## 🌟 核心功能
### 📝 写作助手
...
`;
      ...
      generatedCSS = data.content || data.error || '';
